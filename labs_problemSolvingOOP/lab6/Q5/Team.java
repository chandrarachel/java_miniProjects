...
public class Team{
	...
	public void getStringOfSearchName(String sName){
		for (int i=0;i<allMembers.size();i++){
			if(allMembers.get(i).getName().equals(sName)){
				System.out.print(sName + " is " + allMembers.get(i).getRoleDescription());
			}
		}
	}
